      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {projects.map((project) => (
            ...
            >
              <div
                className={`h-full bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-200 hover:shadow-lg ${activeHover === project.id ? "border-teal-300 dark:border-teal-500" : ""
                  }`}
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex items-center">
                      <div
                        className={`w-1.5 h-1.5 rounded-full mr-1 ${project.status === "Live" ? "bg-green-500" : "bg-amber-500"
                          }`}
                      ></div>
